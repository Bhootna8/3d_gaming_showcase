      ...
      <div className="relative z-10 flex size-full flex-col justify-between p-5 text-blue-100">
        ...
        {isComingSoon && (
          <div
            ...
            className="border-hsla relative flex w-fit cursor-pointer items-center rounded-full bg-black px-5 py-2 text-xs uppercase text-white/20 gap-1 overflow-hidden"
          >
            <div
              style={{
    ...
    <section className="bg-black pb-52">
      <div className="container mx-auto px-3 md:px-10">
        ...
        <div className="grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7">
          ...
          <BentoTilt className="bento-tilt_1 row-span-1  md:col-span-1 sm:ms-0">
            <BentoCard
          ...
          <BentoTilt className="bento-tilt_1 row-span-1 sm:me-0 md:col-span-1">
            <BentoCard
